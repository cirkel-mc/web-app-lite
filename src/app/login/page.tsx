  ...
  return (
    <div className='flex-col md:flex md:flex-row w-[80%] max-w-[700px] fixed z-10 left-1/2 top-1/2 rounded-lg shadow-md bg-white -translate-x-1/2 -translate-y-1/2'>
      <div className='w-full md:width-2/5 p-4'>
        ...
        <p className='text-center text-xs mt-2 mb-4'>Sign in</p>
        ...
        <Button size='sm' round='md' variant='primary' type='fill' classes='w-full mt-6 text-sm py-2' onClick={() => window.location.assign('/')}>Sign in</Button>
        ...
        <p className='text-xs mt-6 text-center'>Does not have account? <Link href="/register" className='text-sky-500'>Sign up here</Link></p>
      </div>
