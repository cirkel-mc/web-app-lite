...
const Description = () => {
  return (
    <div className='flex justify-between mt-4'>
      ...
      <div className='relative border-slate-300 border-[1px] rounded-2xl p-4' style={{ width: 'calc(100% - 120px)' }}>
        ...
        <p className='absolute left-4 bottom-2 italic text-slate-500' style={{ fontSize: '8px' }}>ps: detail booking terdapat di page sebelumnya</p>
      </div>
    </div>
  )
}
