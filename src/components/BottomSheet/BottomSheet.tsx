...
const BottomSheet = (props: BottomSheetProps) => {
  ...
  return (
    <Fragment>
      ...
      <div className={clsx('transition-transform duration-200 ease-out w-full bg-white shadow-lg px-4 py-4', open ? 'transform: translate-y-0' : 'transform: translate-y-[100%]' )} style={{ zIndex: 100, position: 'fixed', left: 0, bottom: 0 }}>
