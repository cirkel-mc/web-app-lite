...
const Menu = (props: MenuProps) => {
  ...
  return (
    <div className={clsx('bg-white shadow-md transition-all duration-500 ease-out fixed top-[68px] left-0 w-full h-full pt-7 pl-5 pb-6 pr-4', show ? 'translate-y-0' : 'translate-y-[100%]')}>
