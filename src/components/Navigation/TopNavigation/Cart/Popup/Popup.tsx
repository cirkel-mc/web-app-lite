...
const Popup = ({ onClose, onSubmit }: any) => {
  return (
    <Fragment>
      ...
      <div className='flex flex-col justify-between fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-white p-6 w-4/5 h-3/5 rounded-lg lg:max-w-[700px]'>
        ...
        <div>
          ...
          <div className='fixed bottom-0 left-0 shadow-2xl w-full px-4 py-4'>
            <div className='max-w-[500px] mx-auto flex items-center justify-between'>
              <p>Rp. 170.000/hour</p>
              <button className='px-2 py-2 rounded-lg bg-teal-600 text-white' onClick={onSubmit}>Book Now!</button>
            </div>
          </div>
        </div>
      </div>
