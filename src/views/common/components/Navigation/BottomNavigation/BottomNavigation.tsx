...
import {Home2, Music, User, Plus, Time} from '@/views/common/components/Icons'
...
const BottomNavigation = () => {
  ...
  return (
    <div className="w-full bg-white fixed bottom-0 left-0 px-2 py-3 shadow-2xl flex justify-around">
      ...
      />
      <div role='button' className='flex flex-col justify-center items-center gap-1 bg-primary-40 pt-2 pb-1 px-2 rounded-md'>
        <Plus size={16} />
